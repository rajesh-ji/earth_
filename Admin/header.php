...
<div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="carbonCredits.php"><img class="imageset" src="images/sidebar/hexagons.png" width="30px"  height="30px" alt="">Carbon credits</a>
                    </li>

                    <li>
                         <a href="farm.php" ><img width="30px"  height="30px" class="imageset" src="images/sidebar/edit.png" alt="">Update farm</a>
                    </li>
                       
                
                    <li>
                        <a href=""><img class="imageset" width="30px"  height="30px" src="images/sidebar/black-wrench.png" alt="">Settings</a>
