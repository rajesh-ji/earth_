...
<div class="container-fluid">
        ...
        <div class="col-md-6 loginutside float-right " style="background-color:#fafafa;">
            ...
            <p class="signin">Reset Password Of Your Account</p>
            ...
            <?php if(isset($_SESSION['mgs'])){
                    ...
                    <div class="form-group">
                        <label for="otp" class="" style="color: #BAB9B9;">One Time Code</label>
                        <input type="text" name="email" class="form-control border-secondary" placeholder="Enter OTP..." required style="border: 0px solid #ccc;">
                    </div>
                    <div class="form-group">
                        <label for="password" class="" style="color: #BAB9B9;">New Password</label>
                ...
                <div>
                    <p class="forgot">New to EM <a href="signup.php" style="color:#A7BF58">Create Account</a></p>
                </div>
            </form>
        </div>
</div>
